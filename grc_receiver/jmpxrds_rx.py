...
class jmpxrds_rx(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(mpx_samp_rate, analog.GR_SIN_WAVE, 1000, 0.2, 0)
        ...
        self.analog_fastnoise_source_x_0 = analog.fastnoise_source_f(analog.GR_GAUSSIAN, 0.2, 0, 8192)
        self.Tones = audio.sink(mpx_samp_rate, 'jack', False)
        self.Noise = audio.sink(mpx_samp_rate, 'jack', False)
        ...
        self.connect((self.analog_fastnoise_source_x_0, 0), (self.Noise, 0))
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_add_xx_1, 4))
        self.connect((self.analog_sig_source_x_1, 0), (self.blocks_add_xx_1, 2))
        ...
        self.connect((self.audio_source_0, 0), (self.fir_filter_xxx_1, 0))
        self.connect((self.audio_source_0, 0), (self.freq_xlating_fir_filter_xxx_1, 0))
        self.connect((self.audio_source_0, 0), (self.freq_xlating_fir_filter_xxx_2, 0))
        self.connect((self.audio_source_0, 0), (self.wxgui_fftsink2_0_0, 0))
        ...
        self.connect((self.blocks_add_xx_1, 0), (self.Tones, 0))
    ...
    def set_mpx_samp_rate(self, mpx_samp_rate):
        with self._lock:
            ...
            self.analog_sig_source_x_4.set_sampling_freq(self.mpx_samp_rate)
            self.analog_sig_source_x_3.set_sampling_freq(self.mpx_samp_rate)
            self.analog_sig_source_x_2.set_sampling_freq(self.mpx_samp_rate)
            self.analog_sig_source_x_1.set_sampling_freq(self.mpx_samp_rate)
            self.analog_sig_source_x_0.set_sampling_freq(self.mpx_samp_rate)
