...
class jmpxrds_rx(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.freq_xlating_fir_filter_xxx_2 = filter.freq_xlating_fir_filter_fcf(1, (firdes.low_pass(1.0,mpx_samp_rate,13e3,3e3,firdes.WIN_HAMMING)), 38000, mpx_samp_rate)
        ...
        self.fir_filter_xxx_1 = filter.fir_filter_fff(1, (firdes.low_pass(1.0,mpx_samp_rate,13e3,3e3,firdes.WIN_HAMMING)))
        ...
        self.analog_fm_deemph_0_0_0 = analog.fm_deemph(fs=mpx_samp_rate, tau=75e-6)
        self.analog_fm_deemph_0_0 = analog.fm_deemph(fs=mpx_samp_rate, tau=75e-6)
    ...
    def set_mpx_samp_rate(self, mpx_samp_rate):
        with self._lock:
            ...
            self.freq_xlating_fir_filter_xxx_2.set_taps((firdes.low_pass(1.0,self.mpx_samp_rate,13e3,3e3,firdes.WIN_HAMMING)))
            self.freq_xlating_fir_filter_xxx_1.set_taps((firdes.low_pass(1.0,self.mpx_samp_rate,2.4e3,2e3,firdes.WIN_HAMMING)))
            self.fir_filter_xxx_1.set_taps((firdes.low_pass(1.0,self.mpx_samp_rate,13e3,3e3,firdes.WIN_HAMMING)))
